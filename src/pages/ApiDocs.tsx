      ...
      <div className="container mx-auto px-6 py-12">
        <div className="mb-8">
          ...
          <p className="font-body text-muted-foreground max-w-2xl">
            REST API completa para integração com a comunidade KORRETORA. Conecte seu app, divulgue imóveis e gerencie parcerias entre corretores autônomos. Todos os endpoints respeitam as políticas de segurança (RLS).
          </p>
        </div>
