...
const ENDPOINTS: Endpoint[] = [
  ...
  {
    method: "POST", path: "—", summary: "Upload S3 (s3-upload)", auth: true,
    description: "Endpoint separado: /functions/v1/s3-upload?action=get_upload_url. Gera URL assinada para upload.",
    requestBody: { filename: "foto.jpg", content_type: "image/jpeg" },
    tags: ["Storage"],
  },
  {
    method: "POST", path: "—", summary: "Leitura S3 (s3-read)", auth: false,
    description: "Endpoint separado: /functions/v1/s3-read. Gera URLs assinadas para leitura de imagens S3.",
